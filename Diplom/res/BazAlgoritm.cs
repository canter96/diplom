...
namespace Diplom.res
{
    class BazAlgoritm
    {
        ...
        public BazAlgoritm(double[,] classX1, double[,] classX2, double[,] classX3, double[,] classX4, double[,] classX5)
        {
        ...
        private void algMain()
        {
            ...
            double[] distancesX1 = new double[4];
            double[] distancesX2 = new double[4];
            double[] distancesX3 = new double[4];
            double[] distancesX4 = new double[4];
            double[] distancesX5 = new double[4];
            double[] minDistances = new double[5];
            int[] index = new int[5];
