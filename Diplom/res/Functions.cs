...
namespace Diplom.res
{
    class Functions
    {
        ...
        public double[] findLimit(double[] array, string which__one, double delta)
        { //поиск верхнего, нижнего допуска
        ...
        public double[] findLimit(double[] array, string which__one, double delta, int oznaka)
        { //поиск верхнего, нижнего допуска
            double[] retArray = new double[array.Length];
            if (which__one == "Up")
            {
        ...
        public double[] countTrue(double[,] matrix)
        { // количестов 1 в столбике
